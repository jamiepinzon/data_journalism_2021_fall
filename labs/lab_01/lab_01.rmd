...
**A4** [Kanawha is the most populous county in West Virginia and Wirt is the least populous.]
...
**A5** [GREENBRIAR HOTEL CORPORATION,8912202, corporation, 500 jobs]
...
**A6** [Jim Justice, The company's website.]
...
**A7** [The minimum loan amount compared to the maximum loan amount is a big contrast. The mean is bigger than the median, so the distribution is positively skewed.]
```{r}
# Write the code to produce your answer here
...
**A8** [The means are all larger than the medians, loan amount is distributed to the side that has more money. Barbour's minimum loan is 312 and the maximum is 1979900, it is a big contrast. ]
```{r}
# Write the code to produce your answer here
