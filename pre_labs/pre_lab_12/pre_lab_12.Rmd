...
**Answer** The data is a cumulative data of the vaccination numbers in Maryland counties. 
...
**Answer** I think the numbers of total represents how many days in a county did actually vaccinated someone. 
...
**Answer** This data represents the numbers of vaccination that didn't specify which county it was performed. 
...
**Answer** Not a lot of people are getting vaccinated in the county and the rank is really low. 
...
**Answer** the trend goes up and then goes down slowly. 
...
**Answer** the lines on the chart are close to each other, making it hard to distinguish the differences between them. and the colors of the different counties are very similar. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** the shape of the lines changed gradually and each lines are easier to tell apart. 
...
**Answer** the map is showing the numbers of covid cases in each county in Maryland.
