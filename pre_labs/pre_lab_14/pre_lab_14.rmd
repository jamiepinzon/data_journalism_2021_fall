...
**Answer**the dataframe shows the tweets from politicians that tweeted about covid 19.
...
**Answer**the unique function outputs the each word only once from a list.
...
**Answer** this function outputs all the words in different rows. 
...
**Answer** The chart shows how many times a word shows in tweets. "Covid" appears a lot compared to the common stop words like "a" "for" "is."
...
**Answer** The stop words are gone and the words that are on the list now is more important. 
...
**Answer** the list from the two years look very similar. What is different is the word vaccine in 2021, it didn't make the list in 2020.
...
**Task** Run the following code and describe the results.
**Answer** the list are now two words. Health looks important. 
...
**Task** Run the following code and describe the results.
**Answer** covid 19 is still the first. Vaccine is the second. Health related words moved down the list.
...
**Task** Run the following code and describe the results.
**Answer** The list for Democrats and Republicans are a little bit different.Covid 19 is still on the top. The Democrats has town hall and social distancing on the list, which the Republicans don't have. The Republicans has American people and cares act on the list that the Democrats don't have. 
...
**Task** Run the following code and describe the results.
**Answer** some words like vaccine and 19 vaccine mean the same thing, but are on the list twice. There are also dashes that are not words. 
...
**Answer** I think the lists of words are put in the categories pretty accurate. 
