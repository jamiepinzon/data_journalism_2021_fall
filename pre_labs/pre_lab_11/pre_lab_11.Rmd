...
**Answer** There are different types of files for hospitals.
...
**Answer**It looks like a data frame. The columns are the information about each hospitals, such as where it is, contact information, etc.
...
**Answer** It is a data frame with the 72 hospitals in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There are 7 types of hospitals in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** this is only showing the data of the 50 General Acute Care hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The plot is showing where the hospitals are in the state according to the longitude and latitude.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I don't see any output. 
First run, "To enable caching of data, set `options(tigris_use_cache = TRUE)` in your R script or .Rprofile."
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is a data frame with information about each counties in the U.S.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is the shapes of all the counties in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is the map of Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now there are two layers, the county map and the dots of each hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The dots are bigger, and according to the number of beds in a hospital, the colors of each dot change accordingly. 
...
**Answer** To install your API key for use in future sessions, run this function with `install = TRUE`.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is data of the 50 General Acute Care hospitals in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This data frame shows the number of beds in hospitals in the counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is information of the population in each county in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a new column called geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There are two data. One is the population of each county in Maryland, and one is the number of beds in each county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** the data frame md_county_population is cleaned up so that it can be joined with md_beds_by_county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The two data are joined together into one. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The NA is replaced by a 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a new column called beds_per_100k which describes the beds per 100k people.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is choropleth map that uses color to show the numbers of beds in hospitals in each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The colors are changed into ones that has more contrast between each other. 
...
**Answer** The counties with no beds have the color gray. 
