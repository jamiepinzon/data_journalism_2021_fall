...
**Answer** It is the webpage of NAICS codes, it has information how each industry get its code. 
...
**Answer** I see the html code for the webpage, and can see how each parts are set up in the webpage. 
...
**Answer** It is the title of the page and the body of the page. 
...
**Answer** It seems to be a simplified html code from above.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It is the code for the word "Sector" as the column head.
...
**Answer** It is from the table "Series code structure example under SIC for CES national series: EES00000001" But now the table became a table in R studio.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I think this contains the frist 6 tables in the webpage.
...
**Answer** It is the information from the first table in the webpage. And the display looks the same. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It is showing information from table 2 of the webpage. 
...
**Answer** this is only showing the Sector column fromthe webpage.
...
**Answer** Table 2 is now showing without the words Source: www.census.gov/cgi-bin/sssd/naics/naicsrch?chart=2012 acting as data inside the table.
...
**Answer** This is a table of information from table 2 on the webpage.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This webpage contains information on employment related data of one NAICS sector. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** This is the html code for the title of this page and start of the body.
...
**Answer** this is the html code for the table "Employment and Unemployment."
...
**Answer** This is the table for the table "Employment and Unemployment" from the webpage.
...
**Answer** This shows the employee numbers in June 2021 from the webpage.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** this is the webpage for the NAICS codes of Mining, Quarrying, and Oil and Gas Extraction industry. It has data of employment related numbers. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This is the webpage for the NAICS codes of Construction. It has data of employment related numbers. 
...
**Answer** I think this is to let us not have to write a code for every different page for NAICS codes. so the output is the differnet pages we want to scrape. 
```{r}
...
**Answer** Now we have a list of the sectors.
```{r}
...
**Answer** The list of sectors are showing.
```{r}
...
**Answer** There's an error in the codeblock. sector_list should be list_of_sectors.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** The code is now working for the list of sectors.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** There is an error in the codeblock becuase we didn't write a code naming something called sector_name
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** The numbers  1 to 1o is showing as a list. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** The table is showing the sector codes and the sector's industry. 
...
**Answer** The output shows that there are 20 rows in naics_industry.
...
**Answer** The output shows all 20 of the industry in the table.
...
**Answer** There is 586.7 for Employment, all employees (seasonally adjusted) in June 2021.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** This is a table from the main page of the NAICS codes.
```{r}
# Define url of page we want to scrape
...
**Answer** the table has a new column called sector_url that is for each data entry.
...
**Answer** another new column sector_xpath_id is showing
...
**Answer** there are now only 19 rows as the sector "Public Administration" is removed.
...
**Answer** The output shows each row's information.
...
**Answer** The output of each row has a url and xpath value.
```{r}
...
**Answer** 19 tables  from the webpage are created.
...
**Answer** the 19 tables now only the second row of the table is kept.
...
**Answer** the different tables are now combined into the same place. 
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** Now the tables only show the sector number, the sector name, and the jun_2021 employment number.
...
**Answer** the 19 rows was in different tables, and now they are combined into one data frame. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This is the NAICS webpage for the mining sector, with employment information on it.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This is the NAICS webpage for the agriculture sector, with employment information on it.
...
**Answer** The employees for Agriculture, Forestry, Fishing and Hunting in June 2021 has no numbers anymore. 
