...
**Answer** group_by is to categorize somthing
summarise(total_loans = n()is to count how many loans there are. 
arrange(desc) is to show the data in descending order
head is to show the top ten entries
...
**Answer** Now the chart is in order, from the lowest to the highest. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Now the chart is sideways. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The gray background is removed. 
...
**Answer** they background is light blue. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** There is now a title "Maryland Counties with Most PPP Loans"
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is a line chart from the dataframe. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** It is the same chart but on the x-axis the month and year is all bunched up and it is hard to read. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now the x-axis's label is slanted and so they are easier to read. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
